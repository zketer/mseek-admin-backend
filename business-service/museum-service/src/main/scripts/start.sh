...
export SERVICE_NAME="museum-service"
...
JVM_OPTS="$JVM_OPTS -Dspring.config.location=classpath:/application.yml,file:$CONFIG_DIR/application-$SPRING_PROFILES_ACTIVE.yml"
